...
let availableTravelers = [' Traveler 001', ' Traveler 004', ' The Director', ' Theta Command', ' Traveler 027', ' Traveler 003', ' Traveler 004', ' Traveler 005', ' Traveler 006', ' Traveler 007', ' Traveler 008', ' Traveler 009', ' Traveler 010', ' Traveler 011',
' Traveler 012', ' Traveler 013', ' Traveler 014', ' Traveler 015', ' Traveler 016', ' Traveler 017', ' Traveler 018', ' Traveler 019', ' Traveler 020', ' Traveler 021', ' Traveler 022', ' Traveler 023', ' Traveler 024', ' Traveler 025', ' Traveler 026',];
...
let availableTells = [' 01:23 AM, 1255 FT', ' 03:42 PM, 486 FT', ' 09:31 AM, 846 FT', ' 7:19 PM, 493 FT', ' 05:22 AM, 615 FT', ' 12:49 PM, 549 FT'];
...
function draw() {
    ...
    if (frameCount < frameBox + 110) {
        xPosBox += windowWidth / 90;
        ...
        if (frameCount % this.switchInterval == 0) {
            if (charType > 1) {
                this.value = String.fromCharCode(
                    0x03FF + 65520 + floor(random(0, 97))
                );
            } else {
